...
%% TITLE
\title{Classificação Textual: Reconhecimento de Padrões de LLM's}
...
%% Course
\newcommand{\Course}{Mestrado em Inteligência Artificial}
...
\newcommand{\UC}{
    \begin{flushleft}
        \par\textcolor{titlepagecolor}{  \LARGE\textbf{\textsf{Unidade Curricular de \\ Aprendizagem Profunda}}}
    \end{flushleft}
}
